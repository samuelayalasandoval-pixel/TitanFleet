/**
 * Gestión del Estado del Sidebar - Módulo Compartido
 ...
 *
 * @module shared/sidebar-state
 * @description Módulo reutilizable para todas las páginas que usan sidebar
 */
...
(function () {
  ...
  try {
    ...
    console.warn('⚠️ No se pudo restaurar el estado del sidebar:', e);
  }
})();

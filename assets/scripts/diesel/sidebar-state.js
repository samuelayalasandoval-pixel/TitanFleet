/**
 * Estado del Sidebar - diesel.html
 * Restaura el estado del sidebar (colapsado/expandido) antes de renderizar
 */
...
(function () {
  ...
  try {
    ...
    console.warn('⚠️ Error restaurando estado del sidebar:', e);
  }
})();
